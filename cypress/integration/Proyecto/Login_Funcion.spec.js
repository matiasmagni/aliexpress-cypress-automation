  ...
  it.only('Inicio de sesión con datos válidos', () => {
    cy.fixture("Selectors/registracion").then((selectores) => {
      cy.fixture("Data/registracion").then((data) => {
        ...
        cy.Verificar_labels(selectores.titulologueo, selectores.titulologueotext)
        ///////// Verifico que exista el label Email address y valido texto del label////////////
        cy.Verificar_labels(selectores.labelemaillogin, selectores.labelemailtext)
        /////////Verifico que exista el input del email, que este visible y habilitado y valido value//////
        cy.Inputtext(selectores.inputemaillogin, data.emailvalido, data.emailvalido)
        //////////Verifico que exista el label Password y verifico texto del label////////////////
        cy.Verificar_labels(selectores.labelpassword, selectores.labelpasswordtext)
        /////Verifico que el input password exista, este habilitado y visible//////////////////
        cy.Inputtext(selectores.inputpass, data.passwordvalido, data.passwordvalido)
        ...
        cy.Verificar_labels(selectores.labelmyaccount, selectores.labelmyaccounttext)
      })
    })
  })
